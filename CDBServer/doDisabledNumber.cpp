...
void DoData(msgpack::object* pObj, BUFFER_OBJ* bobj, const TCHAR* pData)
{
	...
	_variant_t varSign = ep->strEncSign(bobj->strJrhm.c_str(), (const char*)(_bstr_t)var_userid, (const char*)(_bstr_t)var_pwd, method.c_str(), key.substr(0, 3).c_str(), key.substr(3, 3).c_str(), key.substr(6, 3).c_str());
